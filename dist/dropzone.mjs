...
let $4ca367182776f80b$var$defaultOptions = {
   ...
   *       .innerHTML
   *
   */ previewTemplate: (0, (/*@__PURE__*/$parcel$interopDefault($fd6031f88dce2e32$exports))),
    /*
    ...
    addedfile (file) {
        ...
        if (this.previewsContainer && !this.options.disablePreviews) {
            ...
            let removeFileEvent = (e)=>{
                e.preventDefault();
                e.stopPropagation();
                if (file.status === (0, $3ed269f2f0fb224b$export$2e2bcd8739ae039).UPLOADING) return (0, $3ed269f2f0fb224b$export$2e2bcd8739ae039).confirm(this.options.dictCancelUploadConfirmation, ()=>this.removeFile(file));
                else {
...
class $3ed269f2f0fb224b$export$2e2bcd8739ae039 extends (0, $4040acfd8584338d$export$2e2bcd8739ae039) {
    ...
    createThumbnailFromUrl(file, width, height, resizeMethod, fixOrientation, callback1, crossOrigin, ignoreExif = false) {
    ...
    uploadFiles(files) {
        this._transformFiles(files, (transformedFiles)=>{
            ...
            if (files[0].upload.chunked) {
                ...
                if (this.options.parallelChunkUploads) for(let i1 = 0; i1 < file.upload.totalChunkCount; i1++)handleNextChunk();
    ...
    _uploadData(files, dataBlocks) {
        ...
        if (this.options.headers) (0, $ewBKy$justextend)(headers, this.options.headers);
    ...
    constructor(el, options){
        ...
        this.options = (0, $ewBKy$justextend)(true, {}, (0, $4ca367182776f80b$export$2e2bcd8739ae039), elementOptions, options != null ? options : {});
...
function $3ed269f2f0fb224b$var$removeExif(origFileBase64) {
    ...
    let origFile = window.atob(origFileBase64.slice(marker.length));
    ...
    while(head < origFile.length){
        if (origFile.slice(head, head + 2) == "\xff\xda") {
            ...
            let length = origFile.charCodeAt(head + 2) * 256 + origFile.charCodeAt(head + 3);
            let endPoint = head + length + 2;
            let segment = origFile.slice(head, endPoint);
...
function $3ed269f2f0fb224b$var$restoreExif(origFileBase64, resizedFileBase64) {
    ...
    let resizedFile = window.atob(resizedFileBase64.slice(marker.length));
    ...
    let splitPoint = 4 + resizedFile.charCodeAt(4) * 256 + resizedFile.charCodeAt(5);
